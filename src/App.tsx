 ...
 *
 * Everything it does is a CSS transition on transform and opacity. The
 * filmstrip that briefly replaced it ran a permanent requestAnimationFrame
 * loop writing per-card rotateX/rotateY/rotateZ, blur and sepia every frame,
 * plus a pointer parallax and an idle drift that carried on swaying forever
 * once you stopped touching it. That is a lot of motion for a page whose job
 * is to let photographs be looked at.
 *
